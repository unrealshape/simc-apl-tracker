...
- **Action Lists:** 11
- **Total Actions:** 100
- **Lists:** `precombat`, `default`, `aoe_dot`, `cds`, `core_dot`, `direct`, `items`, `misc_cds`, `shiv`, `stealthed`, `vanish`
...
| 5 | `variable` | name=effective_spend_cp,value=cp_max_spend-2<?5 |
| 6 | `stealth` | — |
| 7 | `slice_and_dice` | precombat_seconds=1 |
...
| 4 | `variable` | name=regen_saturated,value=energy.regen_combined>30+10*!talent.dashing_scoundrel |
| 5 | `variable` | name=in_cooldowns,value=dot.kingsbane.ticking\|debuff.shiv.up |
| 6 | `variable` | name=upper_limit_energy,value=energy.pct>=(80-10*talent.vicious_venoms.rank-30*talent.amplifying_poison) |
| 7 | `variable` | name=cd_soon,value=talent.kingsbane&cooldown.kingsbane.remains<3&!cooldown.kingsbane.ready |
| 8 | `variable` | name=not_pooling,value=variable.in_cooldowns\|buff.darkest_night.up\|variable.upper_limit_energy\|fight_remains<=20 |
| 9 | `variable` | name=scent_effective_max_stacks,value=(spell_targets.fan_of_knives*talent.scent_of_blood.rank*2)>?20 |
| 10 | `variable` | name=scent_saturation,value=buff.scent_of_blood.stack>=variable.scent_effective_max_stacks |
| 11 | `call_action_list` | name=stealthed,if=stealthed.rogue\|buff.indiscriminate_carnage.up\|stealthed.improved_garrote\|master_assassin_remains>0 |
| 12 | `call_action_list` | name=cds |
| 13 | `call_action_list` | name=core_dot |
| 14 | `call_action_list` | name=aoe_dot,if=!variable.single_target |
| 15 | `call_action_list` | name=direct |
| 16 | `arcane_torrent` | if=energy.deficit>=15+energy.regen_combined |
| 17 | `arcane_pulse` | — |
| 18 | `lights_judgment` | — |
| 19 | `bag_of_tricks` | — |
...
| # | Action | Conditions |
|---|--------|------------|
| 1 | `variable` | name=dot_finisher_condition,value=combo_points>=variable.effective_spend_cp |
| 2 | `crimson_tempest` | target_if=min:remains,if=spell_targets>=2&variable.dot_finisher_condition&refreshable&target.time_to_die-remains>6&!buff.darkest_night.up |
| 3 | `garrote` | cycle_targets=1,if=combo_points.deficit>=1&pmultiplier<=1&refreshable&!variable.regen_saturated&spell_targets.fan_of_knives<=3&!talent.dashing_scoundrel&target.time_to_die-remains>12 |
| 4 | `rupture` | cycle_targets=1,if=variable.dot_finisher_condition&refreshable&(!dot.kingsbane.ticking\|buff.cold_blood.up)&(!variable.regen_saturated\|!variable.scent_saturation)&target.time_to_die>(7+(talent.dashing_scoundrel*5)+(variable.regen_saturated*6))&!buff.darkest_night.up |
| 5 | `garrote` | if=refreshable&combo_points.deficit=1&(pmultiplier<=1\|remains<=tick_time&spell_targets.fan_of_knives>=3)&(remains<=tick_time*2&spell_targets.fan_of_knives>=3)&(target.time_to_die-remains)>4&master_assassin_remains=0 |

## Action List: `cds`

| # | Action | Conditions |
|---|--------|------------|
| 1 | `variable` | name=deathmark_kingsbane_condition,value=cooldown.kingsbane.remains<=2&buff.envenom.up |
| 2 | `variable` | name=deathmark_condition,value=dot.rupture.ticking&(variable.deathmark_kingsbane_condition\|spell_targets.fan_of_knives>1&buff.slice_and_dice.remains>5\|!talent.kingsbane&dot.crimson_tempest.ticking)&!debuff.deathmark.up |
| 3 | `call_action_list` | name=items |
| 4 | `invoke_external_buff` | name=power_infusion,if=dot.deathmark.ticking |
| 5 | `call_action_list` | name=shiv,if=!buff.darkest_night.up&(!buff.deathstalkers_mark_buff.up\|!variable.single_target) |
| 6 | `deathmark` | if=(variable.deathmark_condition&target.time_to_die>=10)\|fight_remains<=20 |
| 7 | `kingsbane` | if=(debuff.shiv.up\|cooldown.shiv.remains<6)&(buff.envenom.up\|spell_targets.fan_of_knives>1)&(cooldown.deathmark.remains>=50-15*(set_bonus.tww3_fatebound_4pc)\|dot.deathmark.ticking)\|fight_remains<=15 |
| 8 | `thistle_tea` | if=hero_tree.deathstalker&(!buff.thistle_tea.up&debuff.shiv.remains>=6\|!buff.thistle_tea.up&dot.kingsbane.ticking&dot.kingsbane.remains<=6\|!buff.thistle_tea.up&fight_remains<=cooldown.thistle_tea.charges*6) |
| 9 | `call_action_list` | name=misc_cds |
| 10 | `call_action_list` | name=vanish,if=!stealthed.all&master_assassin_remains=0\|talent.indiscriminate_carnage&!talent.improved_garrote&!variable.scent_saturation&active_dot.rupture<spell_targets.fan_of_knives&spell_targets.fan_of_knives>=3 |
| 11 | `cold_blood` | use_off_gcd=1,if=(buff.fatebound_coin_tails.stack>0&buff.fatebound_coin_heads.stack>0)\|debuff.shiv.up&(cooldown.deathmark.remains>50&(!set_bonus.tww3_fatebound_4pc)\|dot.kingsbane.ticking&(set_bonus.tww3_fatebound_4pc)\|!talent.inevitabile_end&effective_combo_points>=variable.effective_spend_cp) |

## Action List: `core_dot`

| # | Action | Conditions |
|---|--------|------------|
| 1 | `garrote` | if=combo_points.deficit>=1&(pmultiplier<=1)&refreshable&target.time_to_die-remains>12 |
| 2 | `rupture` | if=combo_points>=variable.effective_spend_cp&(pmultiplier<=1)&refreshable&!buff.cold_blood.up&target.time_to_die-remains>(4+(talent.dashing_scoundrel*5)+(variable.regen_saturated*6))&(!buff.darkest_night.up\|talent.caustic_spatter&!debuff.caustic_spatter.up) |
| 3 | `crimson_tempest` | if=combo_points>=variable.effective_spend_cp&refreshable&pmultiplier<=persistent_multiplier&!buff.darkest_night.up&!talent.amplifying_poison&spell_targets.fan_of_knives=1 |

## Action List: `direct`

| # | Action | Conditions |
|---|--------|------------|
| 1 | `variable` | name=use_caustic_filler,value=talent.caustic_spatter&dot.rupture.ticking&(!debuff.caustic_spatter.up\|debuff.caustic_spatter.remains<=2)&combo_points.deficit>=1&!variable.single_target |
| 2 | `mutilate` | if=variable.use_caustic_filler |
| 3 | `ambush` | if=variable.use_caustic_filler |
| 4 | `envenom` | if=!buff.darkest_night.up&combo_points>=variable.effective_spend_cp&(variable.not_pooling\|debuff.amplifying_poison.stack>=20\|!variable.single_target) |
| 5 | `envenom` | if=buff.darkest_night.up&effective_combo_points>=cp_max_spend |
| 6 | `variable` | name=use_filler,value=combo_points<=variable.effective_spend_cp&!variable.cd_soon\|variable.not_pooling\|!variable.single_target |
| 7 | `fan_of_knives` | if=buff.clear_the_witnesses.up&(spell_targets.fan_of_knives>=2-(debuff.shiv.up&(!talent.vicious_venoms\|buff.lingering_darkness.up))) |
| 8 | `variable` | name=fok_target_count,value=spell_targets.fan_of_knives>=3-(talent.momentum_of_despair&talent.thrown_precision)+talent.vicious_venoms+talent.blindside |
| 9 | `fan_of_knives` | if=buff.darkest_night.up&combo_points=6&(!talent.vicious_venoms\|spell_targets.fan_of_knives>=2) |
| 10 | `fan_of_knives` | if=variable.use_filler&!priority_rotation&variable.fok_target_count |
| 11 | `ambush` | if=variable.use_filler&(buff.blindside.up\|stealthed.rogue)&(!dot.kingsbane.ticking\|debuff.deathmark.down\|buff.blindside.up) |
| 12 | `mutilate` | target_if=!dot.deadly_poison_dot.ticking&!debuff.amplifying_poison.up,if=variable.use_filler&spell_targets.fan_of_knives=2 |
| 13 | `mutilate` | if=variable.use_filler |

## Action List: `items`

| # | Action | Conditions |
|---|--------|------------|
| 1 | `variable` | name=base_trinket_condition,value=dot.rupture.ticking&cooldown.deathmark.remains<2&!cooldown.deathmark.ready\|dot.deathmark.ticking\|fight_remains<=22 |
...
| 3 | `use_item` | name=treacherous_transmitter,use_off_gcd=1,if=variable.base_trinket_condition |
| 4 | `use_item` | name=unyielding_netherprism,use_off_gcd=1,if=dot.deathmark.ticking&(buff.latent_energy.stack>=16\|fight_remains<=90\|(!trinket.2.cooldown.ready\|!trinket.1.cooldown.ready))\|fight_remains<=20 |
| 5 | `use_item` | name=mad_queens_mandate,if=cooldown.deathmark.remains>=30&!dot.deathmark.ticking\|fight_remains<=3 |
| 6 | `use_item` | name=junkmaestros_mega_magnet,if=cooldown.deathmark.remains>=30&!dot.deathmark.ticking&!debuff.shiv.up&(!talent.deathstalkers_mark\|buff.lingering_darkness.up&buff.junkmaestros_mega_magnet.stack>5)\|fight_remains<=10 |
| 7 | `do_treacherous_transmitter_task` | use_off_gcd=1,if=dot.deathmark.ticking&variable.single_target\|buff.realigning_nexus_convergence_divergence.up&buff.realigning_nexus_convergence_divergence.remains<=2\|buff.cryptic_instructions.up&buff.cryptic_instructions.remains<=2\|buff.errant_manaforge_emission.up&buff.errant_manaforge_emission.remains<=2\|fight_remains<=15 |
| 8 | `use_item` | name=imperfect_ascendancy_serum,use_off_gcd=1,if=variable.base_trinket_condition |
| 9 | `use_items` | slots=trinket1,if=(variable.trinket_sync_slot=1&(debuff.deathmark.up)\|(variable.trinket_sync_slot=2&!trinket.2.cooldown.ready&cooldown.deathmark.remains>20))\|!variable.trinket_sync_slot\|fight_remains<=20 |
| 10 | `use_items` | slots=trinket2,if=(variable.trinket_sync_slot=2&(debuff.deathmark.up)\|(variable.trinket_sync_slot=1&!trinket.1.cooldown.ready&cooldown.deathmark.remains>20))\|!variable.trinket_sync_slot\|fight_remains<=20 |

## Action List: `misc_cds`

| # | Action | Conditions |
|---|--------|------------|
| 1 | `potion` | if=buff.bloodlust.react\|fight_remains<30\|debuff.deathmark.up |
| 2 | `blood_fury` | if=debuff.deathmark.up |
| 3 | `berserking` | if=debuff.deathmark.up |
| 4 | `fireblood` | if=debuff.deathmark.up |
| 5 | `ancestral_call` | if=debuff.deathmark.up |

## Action List: `shiv`

| # | Action | Conditions |
|---|--------|------------|
| 1 | `variable` | name=shiv_condition,value=!debuff.shiv.up&dot.garrote.ticking&dot.rupture.ticking&spell_targets.fan_of_knives<=5 |
| 2 | `variable` | name=shiv_kingsbane_condition,value=talent.kingsbane&buff.envenom.up&variable.shiv_condition |
| 3 | `shiv` | if=talent.lightweight_shiv&variable.shiv_kingsbane_condition&(cooldown.deathmark.ready\|cooldown.deathmark.remains<=1)&(cooldown.kingsbane.ready\|cooldown.kingsbane.remains<=2)&set_bonus.tww3_fatebound_2pc |
| 4 | `shiv` | if=talent.arterial_precision&!debuff.shiv.up&dot.garrote.ticking&dot.rupture.ticking&spell_targets.fan_of_knives>=4&dot.crimson_tempest.ticking&(target.health.pct<=35&talent.zoldyck_recipe\|cooldown.shiv.charges_fractional>=1.9) |
| 5 | `shiv` | if=!talent.lightweight_shiv.enabled&variable.shiv_kingsbane_condition&(dot.kingsbane.ticking&dot.kingsbane.remains<(8+3*(set_bonus.tww3_deathstalker_4pc))\|!dot.kingsbane.ticking&cooldown.kingsbane.remains>=20)&(!talent.crimson_tempest.enabled\|variable.single_target\|dot.crimson_tempest.ticking) |
| 6 | `shiv` | if=debuff.deathstalkers_mark.stack<=2&combo_points>=variable.effective_spend_cp&buff.lingering_darkness.up |
| 7 | `shiv` | if=talent.lightweight_shiv.enabled&variable.shiv_kingsbane_condition&(dot.kingsbane.ticking&dot.kingsbane.remains<(8+3*(set_bonus.tww3_deathstalker_4pc))&dot.kingsbane.remains>4\|cooldown.kingsbane.remains<=1&cooldown.shiv.charges_fractional>=1.7) |
| 8 | `shiv` | if=debuff.deathmark.up&talent.arterial_precision&!debuff.shiv.up&dot.garrote.ticking&dot.rupture.ticking |
| 9 | `shiv` | if=!debuff.deathmark.up&!talent.kingsbane&variable.shiv_condition&(dot.crimson_tempest.ticking\|talent.amplifying_poison)&(((talent.lightweight_shiv+1)-cooldown.shiv.charges_fractional)*30<cooldown.deathmark.remains)&raid_event.adds.in>20 |
| 10 | `shiv` | if=!talent.kingsbane&!talent.arterial_precision&variable.shiv_condition&(!talent.crimson_tempest.enabled\|variable.single_target\|dot.crimson_tempest.ticking) |
| 11 | `shiv` | if=fight_remains<=cooldown.shiv.charges*(8+3*(set_bonus.tww3_deathstalker_4pc)) |

## Action List: `stealthed`

| # | Action | Conditions |
|---|--------|------------|
| 1 | `pool_resource` | for_next=1 |
| 2 | `ambush` | if=!debuff.deathstalkers_mark.up&hero_tree.deathstalker&combo_points<variable.effective_spend_cp&(dot.rupture.ticking\|variable.single_target\|!talent.subterfuge) |
| 3 | `shiv` | if=talent.kingsbane&dot.kingsbane.ticking&dot.kingsbane.remains<8&(!debuff.shiv.up&debuff.shiv.remains<1)&buff.envenom.up |
| 4 | `envenom` | if=effective_combo_points>=variable.effective_spend_cp&dot.kingsbane.ticking&buff.envenom.remains<=3&(debuff.deathstalkers_mark.up\|buff.cold_blood.up\|buff.darkest_night.up&combo_points=7) |
| 5 | `envenom` | if=effective_combo_points>=variable.effective_spend_cp&buff.master_assassin_aura.up&variable.single_target&(debuff.deathstalkers_mark.up\|buff.cold_blood.up\|buff.darkest_night.up&combo_points=7) |
| 6 | `rupture` | target_if=effective_combo_points>=variable.effective_spend_cp&buff.indiscriminate_carnage.up&refreshable&((talent.caustic_spatter&!debuff.caustic_spatter.up&!dot.rupture.ticking)\|!buff.darkest_night.up)&(!variable.regen_saturated\|!variable.scent_saturation\|((!talent.dashing_scoundrel\|!talent.poison_bomb)&buff.indiscriminate_carnage.up&!dot.rupture.ticking))&target.time_to_die>15 |
| 7 | `garrote` | target_if=min:remains,if=stealthed.improved_garrote&(remains<12\|pmultiplier<=1\|(buff.indiscriminate_carnage.up&active_dot.garrote<spell_targets.fan_of_knives))&!variable.single_target&target.time_to_die-remains>2&combo_points.deficit>2-buff.darkest_night.up*2 |
| 8 | `garrote` | if=stealthed.improved_garrote&(pmultiplier<=1\|refreshable)&combo_points.deficit>=1+2*talent.shrouded_suffocation |

## Action List: `vanish`

| # | Action | Conditions |
|---|--------|------------|
| 1 | `pool_resource` | for_next=1,extra_amount=45 |
| 2 | `vanish` | if=dot.deathmark.ticking&buff.cold_blood.up&buff.fatebound_coin_tails.stack>=1&buff.fatebound_coin_heads.stack>=1 |
| 3 | `vanish` | if=!talent.master_assassin&!talent.indiscriminate_carnage&talent.improved_garrote&cooldown.garrote.up&(dot.garrote.pmultiplier<=1\|dot.garrote.refreshable)&(debuff.deathmark.up\|cooldown.deathmark.remains<4)&combo_points.deficit>=(spell_targets.fan_of_knives>?4) |
| 4 | `pool_resource` | for_next=1,extra_amount=45 |
| 5 | `vanish` | if=talent.indiscriminate_carnage&talent.improved_garrote&cooldown.garrote.up&(dot.garrote.pmultiplier<=1\|dot.garrote.refreshable)&spell_targets.fan_of_knives>2&(target.time_to_die-remains>15\|raid_event.adds.in>20) |
| 6 | `vanish` | if=talent.indiscriminate_carnage&!buff.indiscriminate_carnage.up&!talent.improved_garrote&!variable.scent_saturation&spell_targets.fan_of_knives>2&(target.time_to_die-remains>15\|raid_event.adds.in>20) |
| 7 | `vanish` | if=talent.master_assassin&debuff.deathmark.up&dot.kingsbane.remains<=6+3*talent.subterfuge.rank |
| 8 | `vanish` | if=talent.improved_garrote&cooldown.garrote.up&(dot.garrote.pmultiplier<=1\|dot.garrote.refreshable)&(debuff.deathmark.up)&raid_event.adds.in>30 |
...
actions.items+=/use_item,name=unyielding_netherprism,use_off_gcd=1,if=dot.deathmark.ticking&(buff.latent_energy.stack>=16|fight_remains<=90|(!trinket.2.cooldown.ready|!trinket.1.cooldown.ready))|fight_remains<=20

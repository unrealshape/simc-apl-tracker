...
| 20 | `earthquake` | if=buff.call_of_the_ancestors.stack>=3&(buff.master_of_the_elements.up\|!talent.master_of_the_elements\|maelstrom.deficit<15)&spell_targets.chain_lightning=2 |
| 21 | `elemental_blast` | target_if=min:debuff.lightning_rod.remains,if=buff.master_of_the_elements.up\|maelstrom.deficit<15 |
| 22 | `earthquake` | if=(buff.master_of_the_elements.up\|!talent.master_of_the_elements\|maelstrom.deficit<15)&buff.call_of_the_ancestors.up&!talent.elemental_blast&spell_targets.chain_lightning=2 |
| 23 | `earth_shock` | target_if=min:debuff.lightning_rod.remains,if=buff.master_of_the_elements.up\|maelstrom.deficit<15 |
| 24 | `flame_shock` | target_if=min:dot.flame_shock.remains,if=buff.master_of_the_elements.up&dot.flame_shock.refreshable |
| 25 | `voltaic_blaze` | if=talent.crackling_fury&!buff.ascendance.up |
| 26 | `tempest` | — |
| 27 | `chain_lightning` | if=spell_targets.chain_lightning=2 |
| 28 | `lightning_bolt` | — |
| 29 | `flame_shock` | moving=1 |
| 30 | `voltaic_blaze` | moving=1 |
| 31 | `frost_shock` | moving=1 |

...
- **Action Lists:** 10
- **Total Actions:** 166
- **Lists:** `precombat`, `default`, `ar`, `externals`, `fel_dev`, `fel_dev_prep`, `fs`, `fs_execute`, `meta_prep`, `metamorphosis`
...
|---|--------|------------|
| 1 | `snapshot_stats` | — |
| 2 | `variable` | name=single_target,value=spell_targets.spirit_bomb=1 |
| 3 | `variable` | name=small_aoe,value=spell_targets.spirit_bomb>=2&spell_targets.spirit_bomb<=5 |
| 4 | `variable` | name=big_aoe,value=spell_targets.spirit_bomb>=6 |
| 5 | `variable` | name=trinket_1_buffs,value=trinket.1.has_use_buff\|(trinket.1.has_buff.agility\|trinket.1.has_buff.mastery\|trinket.1.has_buff.versatility\|trinket.1.has_buff.haste\|trinket.1.has_buff.crit) |
| 6 | `variable` | name=trinket_2_buffs,value=trinket.2.has_use_buff\|(trinket.2.has_buff.agility\|trinket.2.has_buff.mastery\|trinket.2.has_buff.versatility\|trinket.2.has_buff.haste\|trinket.2.has_buff.crit) |
| 7 | `arcane_torrent` | — |
| 8 | `sigil_of_flame` | if=hero_tree.aldrachi_reaver\|(hero_tree.felscarred&talent.student_of_suffering) |
| 9 | `immolation_aura` | — |
...
| # | Action | Conditions |
|---|--------|------------|
| 1 | `variable` | name=num_spawnable_souls,op=reset,default=0 |
| 2 | `variable` | name=num_spawnable_souls,op=max,value=1,if=talent.soul_sigils&cooldown.sigil_of_flame.up |
| 3 | `variable` | name=num_spawnable_souls,op=max,value=2,if=talent.fracture&cooldown.fracture.charges_fractional>=1&!buff.metamorphosis.up |
| 4 | `variable` | name=num_spawnable_souls,op=max,value=3,if=talent.fracture&cooldown.fracture.charges_fractional>=1&buff.metamorphosis.up |
| 5 | `variable` | name=num_spawnable_souls,op=add,value=1,if=talent.soul_carver&(cooldown.soul_carver.remains>(cooldown.soul_carver.duration-3)) |
| 6 | `auto_attack` | — |
| 7 | `disrupt` | if=target.debuff.casting.react |
| 8 | `infernal_strike` | use_off_gcd=1 |
| 9 | `demon_spikes` | use_off_gcd=1,if=!buff.demon_spikes.up&!cooldown.pause_action.remains |
...
| # | Action | Conditions |
|---|--------|------------|
| 1 | `use_item` | slot=trinket1,if=!trinket.1.is.tome_of_lights_devotion&(!variable.trinket_1_buffs\|(variable.trinket_1_buffs&((buff.metamorphosis.up)\|(buff.metamorphosis.up&cooldown.metamorphosis.remains<10)\|(cooldown.metamorphosis.remains>trinket.1.cooldown.duration)\|(variable.trinket_2_buffs&trinket.2.cooldown.remains<cooldown.metamorphosis.remains)))) |
| 2 | `use_item` | slot=trinket2,if=!trinket.2.is.tome_of_lights_devotion&(!variable.trinket_2_buffs\|(variable.trinket_2_buffs&((buff.metamorphosis.up)\|(buff.metamorphosis.up&cooldown.metamorphosis.remains<10)\|(cooldown.metamorphosis.remains>trinket.2.cooldown.duration)\|(variable.trinket_1_buffs&trinket.1.cooldown.remains<cooldown.metamorphosis.remains)))) |
| 3 | `use_item` | name=tome_of_lights_devotion,if=buff.inner_resilience.up |
| 4 | `potion` | use_off_gcd=1,if=(buff.rending_strike.up&buff.glaive_flurry.up)\|prev_gcd.1.reavers_glaive |
| 5 | `call_action_list` | name=externals,if=(buff.rending_strike.up&buff.glaive_flurry.up)\|prev_gcd.1.reavers_glaive |
| 6 | `metamorphosis` | use_off_gcd=1,if=!buff.metamorphosis.up |
| 7 | `fel_devastation` | use_off_gcd=1,if=!buff.rending_strike.up&!buff.glaive_flurry.up |
| 8 | `soul_cleave` | if=!buff.rending_strike.up&buff.glaive_flurry.up |
| 9 | `shear` | if=talent.fracture&buff.glaive_flurry.up |
| 10 | `shear` | if=!talent.fracture&buff.glaive_flurry.up |
| 11 | `reavers_glaive` | if=!buff.rending_strike.up&!buff.glaive_flurry.up |
| 12 | `the_hunt` | if=!buff.reavers_glaive.up&(buff.art_of_the_glaive.stack+soul_fragments.total)<20 |
| 13 | `fiery_brand` | if=talent.fiery_demise&!dot.fiery_brand.ticking |
| 14 | `soul_carver` | if=!talent.fiery_demise\|(talent.fiery_demise&dot.fiery_brand.ticking) |
| 15 | `sigil_of_spite` | — |
| 16 | `immolation_aura` | if=talent.fallout |
| 17 | `bulk_extraction` | if=spell_targets>=3 |
| 18 | `shear` | if=talent.fracture&buff.metamorphosis.up |
| 19 | `sigil_of_flame` | — |
| 20 | `shear` | if=talent.fracture |
| 21 | `spirit_bomb` | if=spell_targets>=12&soul_fragments>=4 |
| 22 | `soul_cleave` | — |
| 23 | `immolation_aura` | — |
| 24 | `felblade` | — |
| 25 | `vengeful_retreat` | if=talent.unhindered_assault |
| 26 | `throw_glaive` | — |
| 27 | `shear` | if=!talent.fracture |

## Action List: `externals`

| # | Action | Conditions |
|---|--------|------------|
| 1 | `invoke_external_buff` | name=symbol_of_hope |
| 2 | `invoke_external_buff` | name=power_infusion |

## Action List: `fel_dev`

| # | Action | Conditions |
|---|--------|------------|
| 1 | `spirit_bomb` | if=buff.demonsurge_spirit_burst.up&(variable.can_spburst\|soul_fragments>=4\|(buff.metamorphosis.remains<(gcd.max*2))) |
| 2 | `soul_cleave` | if=buff.demonsurge_soul_sunder.up&(!buff.demonsurge_spirit_burst.up\|(buff.metamorphosis.remains<(gcd.max*2))) |
| 3 | `sigil_of_spite` | if=(!talent.cycle_of_binding\|(cooldown.sigil_of_spite.duration<(cooldown.metamorphosis.remains+18)))&(soul_fragments.total<=2&buff.demonsurge_spirit_burst.up) |
| 4 | `soul_carver` | if=soul_fragments.total<=2&!prev_gcd.1.sigil_of_spite&buff.demonsurge_spirit_burst.up |
| 5 | `shear` | if=talent.fracture&soul_fragments.total<=2&buff.demonsurge_spirit_burst.up |
| 6 | `felblade` | if=buff.demonsurge_spirit_burst.up\|buff.demonsurge_soul_sunder.up |
| 7 | `shear` | if=talent.fracture&buff.demonsurge_spirit_burst.up\|buff.demonsurge_soul_sunder.up |

## Action List: `fel_dev_prep`

| # | Action | Conditions |
|---|--------|------------|
| 1 | `potion` | use_off_gcd=1,if=prev_gcd.1.fiery_brand |
| 2 | `sigil_of_flame` | if=!variable.hold_sof_for_precombat&!variable.hold_sof_for_student&!variable.hold_sof_for_dot |
...
| 4 | `fel_devastation` | if=((fury+variable.fel_dev_passive_fury_gen)>=120)&(variable.can_spburst\|variable.can_spburst_soon\|soul_fragments.total>=4) |
| 5 | `sigil_of_spite` | if=(!talent.cycle_of_binding\|(cooldown.sigil_of_spite.duration<(cooldown.metamorphosis.remains+18)))&(soul_fragments.total<=1\|(!(variable.can_spburst\|variable.can_spburst_soon\|soul_fragments.total>=4)&(!talent.fracture\|action.shear.charges_fractional<1))) |
| 6 | `soul_carver` | if=(!talent.cycle_of_binding\|cooldown.metamorphosis.remains>20)&(soul_fragments.total<=1\|(!(variable.can_spburst\|variable.can_spburst_soon\|soul_fragments.total>=4)&(!talent.fracture\|action.shear.charges_fractional<1)))&!prev_gcd.1.sigil_of_spite&!prev_gcd.2.sigil_of_spite |
| 7 | `felblade` | if=!((fury+variable.fel_dev_passive_fury_gen)>=120)&(variable.can_spburst\|variable.can_spburst_soon\|soul_fragments.total>=4) |
| 8 | `shear` | if=talent.fracture&!(variable.can_spburst\|variable.can_spburst_soon\|soul_fragments.total>=4)\|!((fury+variable.fel_dev_passive_fury_gen)>=120) |
| 9 | `felblade` | — |
| 10 | `shear` | if=talent.fracture |
| 11 | `wait` | sec=0.1,if=(!(variable.can_spburst\|variable.can_spburst_soon\|soul_fragments.total>=4)\|!((fury+variable.fel_dev_passive_fury_gen)>=120))&(!talent.fracture\|action.shear.charges_fractional>=0.7) |
| 12 | `fel_devastation` | — |
| 13 | `soul_cleave` | if=((fury+variable.fel_dev_passive_fury_gen)>=150) |
| 14 | `throw_glaive` | — |
...
| # | Action | Conditions |
|---|--------|------------|
| 1 | `variable` | name=crit_pct,op=set,value=(dot.sigil_of_flame.crit_pct+(talent.aura_of_pain*6))%100,if=active_dot.sigil_of_flame>0&talent.volatile_flameblood |
| 2 | `variable` | name=fel_dev_sequence_time,op=set,value=2+(2*gcd.max) |
| 3 | `variable` | name=fel_dev_sequence_time,op=add,value=gcd.max,if=talent.fiery_demise&cooldown.fiery_brand.up |
| 4 | `variable` | name=fel_dev_sequence_time,op=add,value=gcd.max,if=cooldown.sigil_of_flame.up\|cooldown.sigil_of_flame.remains<variable.fel_dev_sequence_time |
| 5 | `variable` | name=fel_dev_sequence_time,op=add,value=gcd.max,if=cooldown.immolation_aura.up\|cooldown.immolation_aura.remains<variable.fel_dev_sequence_time |
| 6 | `variable` | name=fel_dev_passive_fury_gen,op=set,value=0 |
| 7 | `variable` | name=fel_dev_passive_fury_gen,op=add,value=2.5*floor((buff.student_of_suffering.remains>?variable.fel_dev_sequence_time)),if=talent.student_of_suffering.enabled&(buff.student_of_suffering.remains>1\|prev_gcd.1.sigil_of_flame) |
| 8 | `variable` | name=fel_dev_passive_fury_gen,op=add,value=30+(2*talent.flames_of_fury*spell_targets.sigil_of_flame),if=(cooldown.sigil_of_flame.remains<variable.fel_dev_sequence_time) |
| 9 | `variable` | name=fel_dev_passive_fury_gen,op=add,value=8,if=cooldown.immolation_aura.remains<variable.fel_dev_sequence_time |
| 10 | `variable` | name=fel_dev_passive_fury_gen,op=add,value=2*floor((buff.immolation_aura.remains>?variable.fel_dev_sequence_time)),if=buff.immolation_aura.remains>1 |
| 11 | `variable` | name=fel_dev_passive_fury_gen,op=add,value=7.5*variable.crit_pct*floor((buff.immolation_aura.remains>?variable.fel_dev_sequence_time)),if=talent.volatile_flameblood&buff.immolation_aura.remains>1 |
| 12 | `variable` | name=fel_dev_passive_fury_gen,op=add,value=22,if=talent.darkglare_boon.enabled |
| 13 | `variable` | name=spbomb_threshold,op=setif,condition=talent.fiery_demise&dot.fiery_brand.ticking,value=(variable.single_target*5)+(variable.small_aoe*5)+(variable.big_aoe*4),value_else=(variable.single_target*5)+(variable.small_aoe*5)+(variable.big_aoe*4) |
| 14 | `variable` | name=can_spbomb,op=setif,condition=talent.spirit_bomb,value=soul_fragments>=variable.spbomb_threshold,value_else=0 |
| 15 | `variable` | name=can_spbomb_soon,op=setif,condition=talent.spirit_bomb,value=soul_fragments.total>=variable.spbomb_threshold,value_else=0 |
| 16 | `variable` | name=can_spbomb_one_gcd,op=setif,condition=talent.spirit_bomb,value=(soul_fragments.total+variable.num_spawnable_souls)>=variable.spbomb_threshold,value_else=0 |
| 17 | `variable` | name=spburst_threshold,op=setif,condition=talent.fiery_demise&dot.fiery_brand.ticking,value=(variable.single_target*5)+(variable.small_aoe*5)+(variable.big_aoe*4),value_else=(variable.single_target*5)+(variable.small_aoe*5)+(variable.big_aoe*4) |
| 18 | `variable` | name=can_spburst,op=setif,condition=talent.spirit_bomb,value=soul_fragments>=variable.spburst_threshold,value_else=0 |
| 19 | `variable` | name=can_spburst_soon,op=setif,condition=talent.spirit_bomb,value=soul_fragments.total>=variable.spburst_threshold,value_else=0 |
| 20 | `variable` | name=can_spburst_one_gcd,op=setif,condition=talent.spirit_bomb,value=(soul_fragments.total+variable.num_spawnable_souls)>=variable.spburst_threshold,value_else=0 |
| 21 | `variable` | name=meta_prep_time,op=set,value=0 |
| 22 | `variable` | name=meta_prep_time,op=add,value=action.fiery_brand.execute_time,if=talent.fiery_demise&cooldown.fiery_brand.up |
| 23 | `variable` | name=meta_prep_time,op=add,value=action.sigil_of_flame.execute_time*action.sigil_of_flame.charges |
| 24 | `variable` | name=dont_soul_cleave,op=setif,condition=buff.metamorphosis.up&buff.demonsurge_hardcast.up,value=buff.demonsurge_spirit_burst.up\|(buff.metamorphosis.remains<(gcd.max*2)&(!((fury+variable.fel_dev_passive_fury_gen)>=120)\|!(variable.can_spburst\|variable.can_spburst_soon\|soul_fragments.total>=4))),value_else=(cooldown.fel_devastation.remains<(gcd.max*3)&(!((fury+variable.fel_dev_passive_fury_gen)>=120)\|!(variable.can_spburst\|variable.can_spburst_soon\|soul_fragments.total>=4))) |
| 25 | `variable` | name=fiery_brand_back_before_meta,op=setif,condition=talent.down_in_flames,value=charges>=max_charges\|(charges_fractional>=1&cooldown.fiery_brand.full_recharge_time<=gcd.remains+execute_time)\|(charges_fractional>=1&((1-(charges_fractional-1))*cooldown.fiery_brand.duration)<=cooldown.metamorphosis.remains),value_else=(cooldown.fiery_brand.duration<=cooldown.metamorphosis.remains) |
| 26 | `variable` | name=hold_sof_for_meta,op=setif,condition=talent.illuminated_sigils,value=(charges_fractional>=1&((1-(charges_fractional-1))*cooldown.sigil_of_flame.duration)>cooldown.metamorphosis.remains),value_else=cooldown.sigil_of_flame.duration>cooldown.metamorphosis.remains |
| 27 | `variable` | name=hold_sof_for_fel_dev,op=setif,condition=talent.illuminated_sigils,value=(charges_fractional>=1&((1-(charges_fractional-1))*cooldown.sigil_of_flame.duration)>cooldown.fel_devastation.remains),value_else=cooldown.sigil_of_flame.duration>cooldown.fel_devastation.remains |
| 28 | `variable` | name=hold_sof_for_student,op=setif,condition=talent.student_of_suffering,value=prev_gcd.1.sigil_of_flame\|(buff.student_of_suffering.remains>(4-talent.quickened_sigils)),value_else=0 |
| 29 | `variable` | name=hold_sof_for_dot,op=setif,condition=talent.ascending_flame,value=0,value_else=prev_gcd.1.sigil_of_flame\|(dot.sigil_of_flame.remains>(4-talent.quickened_sigils)) |
| 30 | `variable` | name=hold_sof_for_precombat,value=(talent.illuminated_sigils&time<(2-talent.quickened_sigils)) |
| 31 | `use_item` | slot=trinket1,if=!trinket.1.is.tome_of_lights_devotion&(!variable.trinket_1_buffs\|(variable.trinket_1_buffs&((buff.metamorphosis.up&buff.demonsurge_hardcast.up)\|(buff.metamorphosis.up&!buff.demonsurge_hardcast.up&cooldown.metamorphosis.remains<10)\|(cooldown.metamorphosis.remains>trinket.1.cooldown.duration)\|(variable.trinket_2_buffs&trinket.2.cooldown.remains<cooldown.metamorphosis.remains)))) |
| 32 | `use_item` | slot=trinket2,if=!trinket.2.is.tome_of_lights_devotion&(!variable.trinket_2_buffs\|(variable.trinket_2_buffs&((buff.metamorphosis.up&buff.demonsurge_hardcast.up)\|(buff.metamorphosis.up&!buff.demonsurge_hardcast.up&cooldown.metamorphosis.remains<10)\|(cooldown.metamorphosis.remains>trinket.2.cooldown.duration)\|(variable.trinket_1_buffs&trinket.1.cooldown.remains<cooldown.metamorphosis.remains)))) |
| 33 | `use_item` | name=tome_of_lights_devotion,if=buff.inner_resilience.up |
| 34 | `immolation_aura` | if=time<4 |
| 35 | `immolation_aura` | if=!(cooldown.metamorphosis.up&prev_gcd.1.sigil_of_flame)&!(talent.fallout&talent.spirit_bomb&spell_targets.spirit_bomb>=3&((buff.metamorphosis.up&(variable.can_spburst\|variable.can_spburst_soon))\|(!buff.metamorphosis.up&(variable.can_spbomb\|variable.can_spbomb_soon))))&!(buff.metamorphosis.up&buff.demonsurge_hardcast.up) |
| 36 | `sigil_of_flame` | if=!talent.student_of_suffering&!variable.hold_sof_for_dot&!variable.hold_sof_for_precombat |
| 37 | `sigil_of_flame` | if=!variable.hold_sof_for_precombat&(charges=max_charges\|(!variable.hold_sof_for_student&!variable.hold_sof_for_dot&!variable.hold_sof_for_meta&!variable.hold_sof_for_fel_dev)) |
| 38 | `fiery_brand` | if=active_dot.fiery_brand=0&(!talent.fiery_demise\|((talent.down_in_flames&charges>=max_charges)\|variable.fiery_brand_back_before_meta)) |
| 39 | `call_action_list` | name=fs_execute,if=fight_remains<20 |
| 40 | `run_action_list` | name=fel_dev,if=buff.metamorphosis.up&!buff.demonsurge_hardcast.up&(buff.demonsurge_soul_sunder.up\|buff.demonsurge_spirit_burst.up) |
| 41 | `run_action_list` | name=metamorphosis,if=buff.metamorphosis.up&buff.demonsurge_hardcast.up |
| 42 | `run_action_list` | name=fel_dev_prep,if=!buff.demonsurge_hardcast.up&(cooldown.fel_devastation.up\|(cooldown.fel_devastation.remains<=(gcd.max*3))) |
| 43 | `run_action_list` | name=meta_prep,if=(cooldown.metamorphosis.remains<=variable.meta_prep_time)&!cooldown.fel_devastation.up&!cooldown.fel_devastation.remains<10&!buff.demonsurge_soul_sunder.up&!buff.demonsurge_spirit_burst.up |
| 44 | `the_hunt` | — |
| 45 | `felblade` | if=((cooldown.sigil_of_spite.remains<execute_time\|cooldown.soul_carver.remains<execute_time)&cooldown.fel_devastation.remains<(execute_time+gcd.max)&fury<50) |
| 46 | `soul_carver` | if=(!talent.fiery_demise\|talent.fiery_demise&dot.fiery_brand.ticking)&((!talent.spirit_bomb\|variable.single_target)\|(talent.spirit_bomb&!prev_gcd.1.sigil_of_spite&((soul_fragments.total+3<=5&fury>=40)\|(soul_fragments.total=0&fury>=15)))) |
| 47 | `sigil_of_spite` | if=(!talent.cycle_of_binding\|(cooldown.sigil_of_spite.duration<(cooldown.metamorphosis.remains+18)))&(!talent.spirit_bomb\|(fury>=80&(variable.can_spbomb\|variable.can_spbomb_soon))\|(soul_fragments.total<=(2-talent.soul_sigils.rank))) |
| 48 | `spirit_bomb` | if=variable.can_spburst&talent.fiery_demise&dot.fiery_brand.ticking&!(cooldown.fel_devastation.remains<(gcd.max*3)) |
| 49 | `spirit_bomb` | if=variable.can_spbomb&talent.fiery_demise&dot.fiery_brand.ticking&!(cooldown.fel_devastation.remains<(gcd.max*3)) |
| 50 | `soul_cleave` | if=variable.single_target&!variable.dont_soul_cleave |
| 51 | `spirit_bomb` | if=variable.can_spburst&!(cooldown.fel_devastation.remains<(gcd.max*3)) |
| 52 | `spirit_bomb` | if=variable.can_spbomb&!(cooldown.fel_devastation.remains<(gcd.max*3)) |
| 53 | `felblade` | if=((fury<40&((buff.metamorphosis.up&(variable.can_spburst\|variable.can_spburst_soon))\|(!buff.metamorphosis.up&(variable.can_spbomb\|variable.can_spbomb_soon))))) |
| 54 | `shear` | if=talent.fracture&((fury<40&((buff.metamorphosis.up&(variable.can_spburst\|variable.can_spburst_soon))\|(!buff.metamorphosis.up&(variable.can_spbomb\|variable.can_spbomb_soon))))\|(buff.metamorphosis.up&variable.can_spburst_one_gcd)\|(!buff.metamorphosis.up&variable.can_spbomb_one_gcd)) |
| 55 | `felblade` | if=fury.deficit>=40 |
| 56 | `soul_cleave` | if=!variable.dont_soul_cleave |
| 57 | `shear` | if=talent.fracture |
| 58 | `throw_glaive` | — |

## Action List: `fs_execute`

| # | Action | Conditions |
|---|--------|------------|
| 1 | `metamorphosis` | use_off_gcd=1 |
| 2 | `the_hunt` | — |
| 3 | `sigil_of_flame` | — |
| 4 | `fiery_brand` | — |
| 5 | `sigil_of_spite` | — |
...
## Action List: `meta_prep`

| # | Action | Conditions |
|---|--------|------------|
| 1 | `metamorphosis` | use_off_gcd=1,if=cooldown.sigil_of_flame.charges<1 |
| 2 | `fiery_brand` | if=talent.fiery_demise&((talent.down_in_flames&charges>=max_charges)\|active_dot.fiery_brand=0) |
| 3 | `potion` | use_off_gcd=1 |
| 4 | `sigil_of_flame` | — |

## Action List: `metamorphosis`

| # | Action | Conditions |
|---|--------|------------|
| 1 | `call_action_list` | name=externals |
| 2 | `fel_devastation` | if=buff.metamorphosis.remains<(gcd.max*3) |
| 3 | `felblade` | if=fury<50&(buff.metamorphosis.remains<(gcd.max*3))&cooldown.fel_devastation.up |
| 4 | `shear` | if=talent.fracture&fury<50&!cooldown.felblade.up&(buff.metamorphosis.remains<(gcd.max*3))&cooldown.fel_devastation.up |
| 5 | `sigil_of_flame` | if=talent.illuminated_sigils&talent.cycle_of_binding&charges=max_charges |
| 6 | `immolation_aura` | — |
| 7 | `sigil_of_flame` | if=!talent.student_of_suffering&(talent.ascending_flame\|(!talent.ascending_flame&!prev_gcd.1.sigil_of_flame&(dot.sigil_of_doom.remains<(4-talent.quickened_sigils)))) |
| 8 | `sigil_of_flame` | if=talent.student_of_suffering&!prev_gcd.1.sigil_of_flame&!prev_gcd.1.sigil_of_flame&(buff.student_of_suffering.remains<(4-talent.quickened_sigils)) |
| 9 | `sigil_of_flame` | if=buff.metamorphosis.remains<((2-talent.quickened_sigils)+(charges*gcd.max)) |
| 10 | `fel_devastation` | if=soul_fragments<=3&(soul_fragments.inactive>=2\|prev_gcd.1.sigil_of_spite) |
| 11 | `felblade` | if=((cooldown.sigil_of_spite.remains<execute_time\|cooldown.soul_carver.remains<execute_time)&cooldown.fel_devastation.remains<(execute_time+gcd.max)&fury<50) |
| 12 | `soul_carver` | if=(!talent.spirit_bomb\|(variable.single_target&!buff.demonsurge_spirit_burst.up))\|(((soul_fragments.total+3)<=6)&fury>=40&!prev_gcd.1.sigil_of_spite) |
| 13 | `sigil_of_spite` | if=!talent.spirit_bomb\|(fury>=80&(variable.can_spburst\|variable.can_spburst_soon))\|(soul_fragments.total<=(2-talent.soul_sigils.rank)) |
| 14 | `spirit_bomb` | if=variable.can_spburst&buff.demonsurge_spirit_burst.up |
| 15 | `fel_devastation` | — |
| 16 | `the_hunt` | — |
| 17 | `soul_cleave` | if=buff.demonsurge_soul_sunder.up&!buff.demonsurge_spirit_burst.up&!variable.can_spburst_one_gcd |
| 18 | `spirit_bomb` | if=variable.can_spburst&(talent.fiery_demise&dot.fiery_brand.ticking\|variable.big_aoe)&buff.metamorphosis.remains>(gcd.max*2) |
| 19 | `felblade` | if=fury<40&(variable.can_spburst\|variable.can_spburst_soon)&(buff.demonsurge_spirit_burst.up\|talent.fiery_demise&dot.fiery_brand.ticking\|variable.big_aoe) |
| 20 | `shear` | if=talent.fracture&fury<40&(variable.can_spburst\|variable.can_spburst_soon\|variable.can_spburst_one_gcd)&(buff.demonsurge_spirit_burst.up\|talent.fiery_demise&dot.fiery_brand.ticking\|variable.big_aoe) |
| 21 | `shear` | if=talent.fracture&variable.can_spburst_one_gcd&(buff.demonsurge_spirit_burst.up\|variable.big_aoe)&!prev_gcd.1.shear |
| 22 | `soul_cleave` | if=variable.single_target&!variable.dont_soul_cleave |
| 23 | `spirit_bomb` | if=variable.can_spburst&buff.metamorphosis.remains>(gcd.max*2) |
| 24 | `felblade` | if=fury.deficit>=40 |
| 25 | `soul_cleave` | if=!variable.dont_soul_cleave&!(variable.big_aoe&(variable.can_spburst\|variable.can_spburst_soon)) |
| 26 | `felblade` | — |
| 27 | `shear` | if=talent.fracture&!prev_gcd.1.shear |
